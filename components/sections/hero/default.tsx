      ...
      <div className="max-w-container mx-auto flex flex-col gap-12 sm:gap-24">
        <div className="flex flex-col items-center gap-4 text-center sm:gap-10">
          ...
          <div className="flex flex-col gap-4">
            <h1 className="animate-appear from-foreground to-foreground dark:to-muted-foreground relative z-10 inline-block bg-linear-to-r bg-clip-text text-4xl font-semibold text-balance text-transparent drop-shadow-2xl sm:text-6xl md:text-7xl">
              {title}
            </h1>
